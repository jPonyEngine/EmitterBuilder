...
public class AlphaWindow extends InfluencerWindow {
	...
	private void populateWindow() {
		...
		alphaCancel.setDockS(true);
		alphaCancel.setDockE(true);
		...
		alphaEdit.setDockS(true);
		alphaEdit.setDockE(true);
		...
		alphaAdd.setDockS(true);
		alphaAdd.setDockE(true);
		...
		alphaUpdate.setDockS(true);
		alphaUpdate.setDockE(true);
