...
public class SizeWindow extends InfluencerWindow {
	...
	private void populateWindow() {
		...
		sizeCancel.setDockS(true);
		sizeCancel.setDockE(true);
	...
	//	Layout.pos.set(colorA.getX()+colorA.getWidth()-Layout.bWidth,y);
		...
		sizeEdit.setDockS(true);
		sizeEdit.setDockE(true);
		...
		sizeAdd.setText("Add");
		sizeAdd.setDockS(true);
		sizeAdd.setDockE(true);
		ic.addChild(sizeAdd);
		...
		sizeUpdate.setDockS(true);
		sizeUpdate.setDockE(true);
