...
public class DestinationWindow extends InfluencerWindow {
	...
	private void populateWindow() {
		...
		destCancel.setDockS(true);
		destCancel.setDockE(true);
	...
	//	Layout.pos.set(colorA.getX()+colorA.getWidth()-Layout.bWidth,y);
		...
		destEdit.setDockS(true);
		destEdit.setDockE(true);
		...
		destAdd.setText("Add");
		destAdd.setDockS(true);
		destAdd.setDockE(true);
		ic.addChild(destAdd);
		...
		destUpdate.setDockS(true);
		destUpdate.setDockE(true);
