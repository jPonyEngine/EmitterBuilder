...
public class ColorWindow extends InfluencerWindow {
	...
	private void populateWindow() {
		...
		colorCancel.setDockS(true);
		colorCancel.setDockE(true);
		...
		colorEdit.setDockS(true);
		colorEdit.setDockE(true);
	...
	//	colorEdit.hide();
		...
		colorAdd.setDockS(true);
		colorAdd.setDockE(true);
		...
		colorUpdate.setDockS(true);
		colorUpdate.setDockE(true);
