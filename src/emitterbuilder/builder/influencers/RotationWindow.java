...
public class RotationWindow extends InfluencerWindow {
	...
	//	Layout.pos.set(colorA.getX()+colorA.getWidth()-(Layout.bWidth*2)-7,y);
		...
		rotCancel.setDockS(true);
		rotCancel.setDockE(true);
	...
	//	Layout.pos.set(colorA.getX()+colorA.getWidth()-Layout.bWidth,y);
		...
		rotEdit.setDockS(true);
		rotEdit.setDockE(true);
		ic.addChild(rotEdit);
		...
		rotAdd.setText("Add");
		rotAdd.setDockS(true);
		rotAdd.setDockE(true);
		ic.addChild(rotAdd);
		...
		rotUpdate.setDockS(true);
		rotUpdate.setDockE(true);
