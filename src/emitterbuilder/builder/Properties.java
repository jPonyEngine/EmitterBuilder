...
public class Properties extends CollapsableWindow {
	...
	protected void populateWindow() {
		...
		directionType = new SelectBox(screen, "directionType", Layout.pos, Layout.dim) {
			...
			public void onChange(int selectedIndex, Object value) {
				if (builder.emitter != null) {
					builder.emitter.getEmitter().getShape().setDirectionType(DirectionType.valueOf(directionType.getSelectedListItem().getCaption()));
				}
			}
		};
	...
	public void loadProperties() {
		...
		directionType.setSelectedByCaption(builder.emitter.getEmitter().getShape().getDirectionType().name(), true);
